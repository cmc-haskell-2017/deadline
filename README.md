# Deadline
Игра «Deadline», бесконечный платформер. Игра реализована студентом 325 группы, Ким Джун Мюн, в рамках курса по языку Haskell ВМК МГУ. В частности, в данной ветви для индивидуальной части рассматривается взаимодействие с базой данных.
