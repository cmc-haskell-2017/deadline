...
drawPlatforms p = (pictures (map drawPlatform (takeWhile onScreen p)))
  where
...
drawUniverse images u = pictures
  ...
  , drawBonuses (universeBonusBottle u) (bonusBottle images)
  , drawBonuses (universeBonusStar u) (bonusStar images)
  , drawBonuses (universeBonusCoffee u) (bonusCoffee images)
  , drawBonuses (universeBonusRedBull u) (bonusRedBull images)
  , drawBonuses (universeBonusSpeed u) (bonusSpeed images)
  , drawBorders
  , drawText 5 4.5 (-1.5) "DEADLINE"
  , drawText 5 4.35 (-22.9) "exhaustion"
  , drawText 5 1 (-1.5) (show (truncate (universeScore u)))
  , drawBonusInt 30 30 (bonusBottle images) (bonusBottleInt (universePlayer u))
  , drawBonusInt 55 30 (bonusSpeed images) (bonusSpeedInt (universePlayer u))
  , drawBonusInt 80 30 (bonusCoffee images) (bonusCoffeeInt (universePlayer u))
  , drawBonusInt 105 30 (bonusRedBull images) (bonusRedBullInt (universePlayer u))
